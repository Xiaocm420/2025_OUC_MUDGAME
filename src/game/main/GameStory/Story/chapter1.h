...
inline std::string playerName = "主角"; // TODO: 应该改成传入参数

inline DialogNode _00000001(00000001, "???", "欢迎！这是你第一次进入这个游戏，来给你自己起个名字吧:");

inline DialogNode _00000002(00000002, "???", " 吗？嗯嗯，确实是个好名字呢，祝你玩的开心...");
